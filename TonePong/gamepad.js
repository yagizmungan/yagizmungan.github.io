    ...
    if (rawGamepads) {
      ...
      for (var i = 0; i < rawGamepads.length; i++) {
        ...
        if (rawGamepads[i]) {
          ...
          if(i == 0){
            SendMessage('Player','UpdateGamepadInput', gamepadSupport.gamepads[i].axes[1]);
            SendMessage('Computer','UpdateGamepadSelfInput', gamepadSupport.gamepads[i].axes[3]);          
          }
          else if(i == 1){
            SendMessage('Computer','UpdateGamepadInput', gamepadSupport.gamepads[i].axes[1]);
          }
