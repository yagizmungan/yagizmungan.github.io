...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = self.PARTICLE_NOISE_TEXTURE || textureLoader.load("assets/images/perlin-512.png");
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	self.particleSpriteTex = self.PARTICLE_SPRITE_TEXTURE || textureLoader.load("assets/images/particle2.png");
...
THREE.GPUParticleContainer = function(maxParticles, particleSystem) {
	...
	this.spawnParticle = function(options) {
		...
		self.velCol.array[i * 4 + 1] = decodeFloat(rgb[0], rgb[0], rgb[0], 254); //color
